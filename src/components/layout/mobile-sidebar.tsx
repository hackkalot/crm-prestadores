...
export function MobileSidebar({ user, pendingUsersCount = 0, accessiblePages = [] }: MobileSidebarProps) {
      ...
      <SheetContent side="left" className="w-72 p-0">
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center px-6 border-b">
            <Link href="/candidaturas" className="flex items-center gap-2" onClick={close}>
