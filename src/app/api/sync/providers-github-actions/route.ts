...
/**
 * POST /api/sync/providers-github-actions
 *
 * Triggers the GitHub Actions workflow to sync providers data.
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (logError) {
      console.error('Failed to create provider sync log:', logError)
    }

    // Trigger GitHub Actions workflow via repository_dispatch
    console.log('🚀 Triggering GitHub Actions: sync-providers')
