-- Replace coverage view with function that accepts period parameter

-- Drop existing view
DROP VIEW IF EXISTS provider_coverage_by_service CASCADE;
DROP VIEW IF EXISTS municipality_coverage_overview CASCADE;

-- Create function that returns coverage data with configurable period
...
-- Comments
COMMENT ON FUNCTION get_provider_coverage_by_service IS 'Retorna cobertura de prestadores por serviço e concelho, com período configurável em meses';
