-- Fix: Filter by counties (municipalities) instead of districts
-- counties contains the specific municipalities the provider covers
-- client_town in service_requests is the municipality of the request
...
-- Create function filtering by counties (municipality level)
...
-- Comments
COMMENT ON FUNCTION get_provider_coverage_by_service IS 'Retorna cobertura de prestadores por serviço e concelho. Filtra por counties (concelhos que o prestador cobre).';
